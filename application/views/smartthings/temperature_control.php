...
<head>
    <?php $this->load->view('smartthings/common/header'); ?>
</head>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Smart Home Analytics</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <?php $this->load->view('smartthings/common/menu_side'); ?>
        </nav>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Temperature Control <small> Overview</small>
                        </h1>
                    </div>
                </div>
                <!-- Graph row -->
    ...
    <script src="<?=site_url('smartthings/main_chart_data')?>"></script>
