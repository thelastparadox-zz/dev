    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">House Price Monitoring</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="container-fluid">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&pound;<?=number_format($latest_price['price'])?></div>
                        ...
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">&pound;<?=number_format($projected_profit)?></div>
                ...
                <div class="row">                    
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Price History</h3>
                            </div>
                            <div class="panel-body">
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            <?php foreach ($house_prices as $no => $data) { ?>
                                              <tr>
                                                <td><?=$data['date']?></td>
                                                <td>&pound;<?=number_format($data['price'])?></td>
                                                <td><?=$data['source']?></td>
                                                <td>&nbsp;</td>
                                              </tr>
                                            <?php } ?>
